...
return (
  <main className="relative min-h-screen bg-gradient-to-br from-blue-50 via-white to-blue-100 p-0">
    {/* Hero Section with categories embedded */}
    <section className="w-full bg-gradient-to-r from-blue-700 via-blue-500 to-blue-400 py-10 px-2 sm:py-14 sm:px-4 md:px-0 flex flex-col items-center justify-center shadow-lg animate-fade-in">
      <h1 className="text-3xl sm:text-4xl md:text-6xl font-extrabold text-white drop-shadow-lg mb-4 flex items-center gap-2 sm:gap-4 tracking-tight animate-fade-in">
        <svg
          ...
          strokeWidth="1.5"
          stroke="currentColor"
          className="h-8 w-8 sm:h-12 sm:w-12 text-white/90 animate-bounce"
        >
          <path
            strokeLinecap="round"
      ...
      <p className="text-blue-100/90 text-xs sm:text-base md:text-lg font-light max-w-xs sm:max-w-xl text-center animate-fade-in delay-300 mt-2">
        <span className="font-semibold text-white/90">Author & Contact:</span>{" "}
        <a href="mailto:cholycy@gmail.com" className="underline hover:text-blue-200">
          cholycy@gmail.com
        </a>
        <br />
      </p>

      {/* Categories embedded below hero text */}
      <div className="w-full max-w-6xl mt-10 px-4 md:px-0">
        <section className="bg-white/60 rounded-2xl shadow-xl border border-blue-100 p-6 md:p-10 animate-fade-in backdrop-blur-md">
          <h2 className="text-3xl md:text-4xl font-bold text-blue-700 mb-8 flex items-center gap-3">
            <span className="inline-block bg-blue-100 text-blue-700 rounded-full px-4 py-2 text-lg font-semibold shadow">
              Categories
            </span>
          </h2>
          <AboutCarousel />
